# AI-Gym-Fitness-assistent
An AI-powered smart fitness platform that helps users achieve their health and workout goals through personalized recommendations, real-time exercise tracking, posture correction, and intelligent health analysis. 
...
🖥️ UI Tabs
Dashboard – BMI gauge, macro pie chart, weekly calorie bar
Workout Trainer – Simulated rep counter, posture tips, workout logger
Diet Planner – Daily meal plan, calorie progress, meal logger
Performance – Score timeline, reps by exercise, session log table
Gym Buddy – Real-time chat with sentiment-aware AI assistant
IoT Monitor – Live heart-rate and load charts from simulated sensors
Habit Tracker – Daily check-in, skip prediction, weekly summary
Recommender – Personalised workout & gym recommendations
🛠️ Tech Stack
Layer	Technology
Frontend	Streamlit
